...
import io.gudnam.kotlin_realm.BuildConfig
import io.gudnam.kotlin_realm.R
import io.gudnam.kotlin_realm.data.api.APIRequestInterceptor
import io.gudnam.kotlin_realm.data.api.APIService
import io.gudnam.kotlin_realm.di.qualifier.APIAccessToken
...
class DataModule {
    ...
    fun provideRestAdapter(client: OkHttpClient): Retrofit {
        return Retrofit.Builder()
                .baseUrl("https://gudnam.com/v1/mobile")
                .client(client)
