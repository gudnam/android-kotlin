package io.gudnam.kotlin_realm.ui.screen.auth

import android.support.annotation.VisibleForTesting
import android.text.Editable
import android.text.TextWatcher
import android.view.View
import io.gudnam.kotlin_realm.R
...
import io.gudnam.kotlin_realm.ui.base.BaseFragment
 ...
 */
class IdentifyFragment(val phoneNumber: String) : BaseFragment(), IdentifyView {
    ...
    override fun onResume() {
        super.onResume()
        presenter.onResume()
        subscribe(Observable.merge(createAuthNumberTextChangeObservable(), createNextButtonClickObservable()))
    }
    ...
    fun createAuthNumberTextChangeObservable(): Observable<String> {
    ...
    fun createNextButtonClickObservable(): Observable<String> {
        return Observable.create { emitter ->
            ...
            btn_next.setOnClickListener(View.OnClickListener {
                presenter.onNextButtonClicked(phoneNumber, et_auth_number.text.toString())
